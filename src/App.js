...
function App() {
  ...
  useEffect (() => {
    ...
    const success = pos => {
      ...
      axios.get(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=79fc9e57bcc22957957b42579bc134eb`)
  ...
  let linkFund = "";
    ...
    switch (fundTime){
      ...
      case '04d':
        ...
        break;
      case '04n':
        linkFund = 'https://images.pexels.com/photos/2775196/pexels-photo-2775196.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'
        break;
      case '09d':
  ...
  return (
    ...
    <Time className="time"/>
    <button className='change' onClick={() => setIsCelsius(!isCelsius)}> Degrees ºF/ºC </button>
